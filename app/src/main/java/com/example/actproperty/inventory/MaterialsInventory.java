...
public class MaterialsInventory implements Serializable {

    private String StoreCode;
    private int id, hanging6fo, hanging12fo, hanging24fo, odf6fo, odf12fo, odf24fo, closure6fo,
            closure12fo, closure24fo, bl300, bl400, clamp, sc_lc5, sc_lc10;

    public MaterialsInventory(int id, String storeCode, int hanging6fo, int hanging12fo, int hanging24fo,
                              int odf6fo, int odf12fo, int odf24fo, int closure6fo, int closure12fo,
                              int closure24fo, int bl300, int bl400, int clamp, int sc_lc5, int sc_lc10) {
        StoreCode = storeCode;
        this.id = id;
